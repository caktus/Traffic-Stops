    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "type",
                    models.CharField(choices=[("D", "Driver"), ("P", "Passenger")], max_length=2),
                ),
                ("age", models.PositiveSmallIntegerField()),
                (
                    "gender",
                    models.CharField(choices=[("M", "Male"), ("F", "Female")], max_length=2),
                ),
                (
                    "ethnicity",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("person", models.ForeignKey(to="nc.Person", on_delete=models.CASCADE)),
            ],
            bases=(models.Model,),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("person", models.ForeignKey(to="nc.Person", on_delete=models.CASCADE)),
                ("search", models.ForeignKey(to="nc.Search", on_delete=models.CASCADE)),
            ],
            bases=(models.Model,),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "agency",
                    models.ForeignKey(
                        null=True, to="nc.Agency", related_name="stops", on_delete=models.CASCADE
                    ),
                ),
            ],
            bases=(models.Model,),
        ...
        migrations.AddField(
            ...
            name="stop",
            field=models.ForeignKey(to="nc.Stop", on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name="search",
            name="stop",
        ...
        migrations.AddField(
            ...
            name="person",
            field=models.ForeignKey(to="nc.Person", on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name="contraband",
            name="search",
            field=models.ForeignKey(to="nc.Search", on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name="contraband",
            name="stop",
