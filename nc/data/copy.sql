...
-- import stops
\set import_file :data_dir '/test.sql'
\i '/tmp/test.sql'
-- \copy nc_stop (stop_id, agency_description, date, purpose, action, driver_arrest, passenger_arrest, encounter_force, engage_force, officer_injury, driver_injury, passenger_injury, officer_id, stop_location, stop_city) FROM '/home/jgibson/local_dev/tsc/active_projects/Traffic-Stops/ncdata/Stop.csv' WITH DELIMITER ',' NULL AS '' CSV HEADER FORCE NOT NULL officer_id, stop_city, stop_location
